...
class Individual(BaseSolver):
    ...
    def mutate_pieces_position(self):
        ...
        self.chess_board.pieces[random_index].position = random.choice(empty_tiles)
    ...
    def set_id(self):
        Individual.individual_count += 1
        self.id = Individual.individual_count
